...
<html>
	<head>
		...
		<!-- Custom CSS -->
		<link href="navbar-top-fixed.css" type="text/css" rel="stylesheet" />
		<link href="background.css" type="text/css" rel="stylesheet" />
		<link href="sizes.css" type="text/css" rel="stylesheet" />
    ...
    <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        ...
        <form class="form-inline my-2 my-md-0">
          <input class="form-control mr-sm-2" type="text" placeholder="Radiosender">
