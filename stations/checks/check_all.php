 <?php
	...
	for($i = 1; $i <= $max; $i++){
		...
		$hourlystatsRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM hourlyStats WHERE stationId = '$station' and timestamp LIKE '2017-10-04%'"));		//Check if hourlystats exitst for current hour
